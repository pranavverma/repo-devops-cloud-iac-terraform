###############################################################################
# Networking module
# Provisions a VPC with public and private subnets across multiple AZs,
# an Internet Gateway, NAT Gateways (one per AZ for HA), and the routing
# tables that wire everything together.
###############################################################################
...
# ── Private route tables (one per AZ to route through its own NAT) ───────────
